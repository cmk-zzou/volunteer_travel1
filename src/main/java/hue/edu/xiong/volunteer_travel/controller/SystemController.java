...
//
    ...
    public Result delUser(String id) {
        return systemService.delUser(id);
    }

    @RequestMapping("/deleteAttraction")
    @ResponseBody
    public Result deleteAttraction(String id) {
        return systemService.deleteAttraction(id);
    }

    @RequestMapping("/deleteHotel")
    @ResponseBody
    public Result deleteHotel(String id) {
        return systemService.deleteHotel(id);
    }


    @RequestMapping("/deleteRoute")
    @ResponseBody
    public Result deleteRoute(String id) {
        return systemService.deleteRoute(id);
    }

    @RequestMapping("/deleteStrategy")
    @ResponseBody
    public Result deleteStrategy(String id) {
        return systemService.deleteStrategy(id);
    }
