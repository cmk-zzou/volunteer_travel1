...
public class SystemService {
    ...
    public Result deleteRoute(String id) {
        travelRouteRepository.delete(getTravelRouteById(id));
        return ResultGenerator.genSuccessResult();
    }

    @Transactional(rollbackFor = Exception.class)
    public Result deleteAttraction(String id) {
        attractionsRepository.delete(getAttractionsById(id));
        return ResultGenerator.genSuccessResult();
    }

    @Transactional(rollbackFor = Exception.class)
    public Result deleteStrategy(String id) {
        travelStrategyRepository.delete(getTravelStrategyById(id));
        return ResultGenerator.genSuccessResult();
    }
